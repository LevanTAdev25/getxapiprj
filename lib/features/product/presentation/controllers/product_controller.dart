...
class ProductController extends GetxController {
  ...
  Future<void> loadProductList({bool reset = false}) async {
    ...
    try {
      ...
      await BaseUnauthorized.handleUnauthorized();
    } catch (e) {
      isError.value = true;
  ...
  Future<void> addProduct() async {
    ...
    try {
      ...
      Get.snackbar(
        "Thất bại",
        "Không thể thêm sản phẩm, ${message}",
  ...
  Future<void> updateProduct() async {
    ...
    try {
      ...
      Get.snackbar(
        "Thất bại",
        "Không thể cập nhật sản phẩm, ${message}",
        backgroundColor: Colors.red,
        colorText: Colors.white,
        duration: Duration(seconds: 2),
      );
  ...
  void logout() async {
    ...
    Get.snackbar(
      "Đăng xuất",
      "Bạn đã đăng xuất ra khỏi ứng dụng",
      backgroundColor: Colors.green,
      colorText: Colors.white,
    );
    Get.offAllNamed(AppPage.PRODUCTS);
  }
}
